...
- Reference skill file explicitly (e.g., "MUST reference `.claude/skills/prose-generation/SKILL.md`")
...
**Related Documents**:
- `.claude/workflows/primary-workflow.md` - Main workflow definition

...
- **CLAUDE.md**: Main Claude Code configuration (references these workflows)
...
- **Agent Definitions**: `.claude/agents/` (agent-specific instructions)
- **Skill Definitions**: `.claude/skills/` (skill procedures)

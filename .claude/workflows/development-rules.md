...
1. **Reference skill explicitly**: "MUST reference `.claude/skills/[skill-name]/SKILL.md`"
...
Each agent file (`.claude/agents/[agent-name].md`) MUST include:
...
Each skill file (`.claude/skills/[skill-name]/SKILL.md`) MUST include:
...
**Related Documents**:
- `.claude/workflows/primary-workflow.md` - Main workflow

...
- Status: Initial writer-agent draft for P4-C7.  
- Word Count: ~1,700 (to be refined with examples, figures, and labs).  
- Voice: "we" / balanced, aligned with Part 4 style.  
- Citations: To be added when connecting to standard language-to-action references and research papers in later passes.

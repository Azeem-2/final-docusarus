...
- Status: Initial writer-agent draft for P3-C6.  
- Word Count: ~1,600 (to be refined with examples, figures, and labs).  
- Voice: "we" / balanced, aligned with earlier chapters.  
- Citations: To be added when connecting to standard simulation platform references and documentation in later passes.

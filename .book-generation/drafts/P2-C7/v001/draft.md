...
- Status: Initial writer-agent draft for P2-C7.  
- Word Count: ~1,600 (to be refined with examples and figures).  
- Voice: “we” / balanced, aligned with Part 2.  
- Citations: To be added when a dedicated control-systems research scaffold is created.  

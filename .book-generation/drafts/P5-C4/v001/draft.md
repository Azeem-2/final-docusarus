...
- Status: Initial writer-agent draft for P5-C4.  
- Word Count: ~1,600 (to be refined with examples, figures, and labs).  
- Voice: "we" / balanced, aligned with Part 5 style.  
- Citations: To be added when connecting to standard manipulation references and research papers in later passes.

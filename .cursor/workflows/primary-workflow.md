...
**PHR Creation**: All agents MUST create Prompt History Records after completion (see CURSOR.md for PHR protocol).

**ADR Suggestions**: Agents must suggest ADRs for architecturally significant decisions (see CURSOR.md for ADR protocol).
...
**Next Steps**: See `.cursor/workflows/orchestration-protocol.md` for detailed agent coordination rules.

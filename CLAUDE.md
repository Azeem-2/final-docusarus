...
- **Primary Workflow**: `./.claude/workflows/primary-workflow.md` — Complete agent invocation sequence and phase definitions
- **Orchestration Protocol**: `./.claude/workflows/orchestration-protocol.md` — Agent coordination, handoff rules, and validation procedures
- **Development Rules**: `./.claude/workflows/development-rules.md` — Code quality standards, agent orchestration rules, and quality gates
...
See `.claude/workflows/primary-workflow.md` for complete workflow details.
...
- `.claude/workflows/` — Agent orchestration workflows
